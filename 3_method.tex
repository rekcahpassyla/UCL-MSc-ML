...
Rank / Seed &1 &2 &3 &4 &5 \\
    \toprule
1&\begin{tabular}[c]{@{}l@{}} Water \\ 0.263 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Water \\ 0.202 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Book \\ 0.301 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Smile \\ 0.250 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Flower \\ 0.309 \end{tabular} \\
2&\begin{tabular}[c]{@{}l@{}} Smile \\ 0.302 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Smile \\ 0.237 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Smile \\ 0.329 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Computer \\ 0.298 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Water \\ 0.317 \end{tabular} \\
3&\begin{tabular}[c]{@{}l@{}} Flower \\ 0.318 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Flower \\ 0.278 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Flower \\ 0.333 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Book \\ 0.303 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Smile \\ 0.324 \end{tabular} \\
4&\begin{tabular}[c]{@{}l@{}} Screenshot \\ 0.343 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Screenshot \\ 0.313 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Water \\ 0.341 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Cartoon \\ 0.322 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Screenshot \\ 0.348 \end{tabular} \\
5&\begin{tabular}[c]{@{}l@{}} Book \\ 0.381 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Handwriting \\ 0.342 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Screenshot \\ 0.354 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Water \\ 0.345 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Book \\ 0.351 \end{tabular} \\

    \end{tabular}
    \end{table}

This table shows the 5 nearest neighbours to the concept ``Domestic short-haired cat" in the Open Images domain, also over five seeds. This looks a lot more sensible. 

    \begin{table}[h]
    \begin{tabular}{@{}llllll@{}}
Rank / Seed &1 &2 &3 &4 &5 \\
    \toprule
1&\begin{tabular}[c]{@{}l@{}} Malayan cat \\ 0.119 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Malayan cat \\ 0.134 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Malayan cat \\ 0.211 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Malayan cat \\ 0.169 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Malayan cat \\ 0.116 \end{tabular} \\
2&\begin{tabular}[c]{@{}l@{}} Tabby cat \\ 0.373 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tabby cat \\ 0.407 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tabby cat \\ 0.438 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tabby cat \\ 0.382 \end{tabular}&\begin{tabular}[c]{@{}l@{}} European shorthair \\ 0.385 \end{tabular} \\
3&\begin{tabular}[c]{@{}l@{}} European shorthair \\ 0.379 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Himalayan \\ 0.430 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Himalayan \\ 0.443 \end{tabular}&\begin{tabular}[c]{@{}l@{}} European shorthair \\ 0.418 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tabby cat \\ 0.425 \end{tabular} \\
4&\begin{tabular}[c]{@{}l@{}} Russian blue \\ 0.404 \end{tabular}&\begin{tabular}[c]{@{}l@{}} European shorthair \\ 0.440 \end{tabular}&\begin{tabular}[c]{@{}l@{}} European shorthair \\ 0.448 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Russian blue \\ 0.420 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Himalayan \\ 0.489 \end{tabular} \\
5&\begin{tabular}[c]{@{}l@{}} Himalayan \\ 0.417 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Black cat \\ 0.447 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Ragdoll \\ 0.495 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Black cat \\ 0.455 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Russian blue \\ 0.497 \end{tabular} \\

    \end{tabular}
    \end{table}

Entropy distributions for the two concepts over 5 seeds:

\begin{verbatim}
In [46]: get_entropies('ProbabilisticGlove', 0, 'openimages', 'Cat')
Out[46]: 
1   -3.318421
2   -4.106071
3   -3.807085
...
In [47]: get_entropies('ProbabilisticGlove', 0, 'openimages', 'Domestic short-haired cat')
Out[47]: 
1   -1.748797
2   -1.709205
3   -2.051872
...
Rank / Seed &1 &2 &3 &4 &5 \\
    \toprule
1&\begin{tabular}[c]{@{}l@{}} Roti prata \\ 0.222 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Roti prata \\ 0.264 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Roti prata \\ 0.145 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Roti prata \\ 0.214 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Roti prata \\ 0.224 \end{tabular} \\
2&\begin{tabular}[c]{@{}l@{}} Tortilla de patatas \\ 0.235 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Roti \\ 0.299 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Pastelón \\ 0.329 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Garlic fingers \\ 0.301 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tortilla de patatas \\ 0.321 \end{tabular} \\
3&\begin{tabular}[c]{@{}l@{}} Pastelón \\ 0.244 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Paratha \\ 0.303 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Timballo \\ 0.340 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Paratha \\ 0.346 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Uttapam \\ 0.338 \end{tabular} \\
4&\begin{tabular}[c]{@{}l@{}} Paratha \\ 0.287 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Uttapam \\ 0.315 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Pastitsio \\ 0.350 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Talo \\ 0.405 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tomato omelette \\ 0.340 \end{tabular} \\
5&\begin{tabular}[c]{@{}l@{}} Timballo \\ 0.360 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Naan \\ 0.358 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Bobotie \\ 0.376 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Sicilian pizza \\ 0.430 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Sicilian pizza \\ 0.346 \end{tabular} \\

    \end{tabular}
    \end{table}


This is another example of the above. ``Petimezi" is grape molasses, not a very common foodstuff. Despite this, the algorithm has captured enough from the co-occurrence statistics of the entire Open Images collection to come up with some very closely related other concepts. 

    \begin{table}[]
    \begin{tabular}{@{}llllll@{}}
Rank / Seed &1 &2 &3 &4 &5 \\
\toprule
1&\begin{tabular}[c]{@{}l@{}} Barley malt syrup \\ 0.105 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Barley malt syrup \\ 0.245 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Barley malt syrup \\ 0.417 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Brown rice syrup \\ 0.158 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Brown rice syrup \\ 0.138 \end{tabular} \\
2&\begin{tabular}[c]{@{}l@{}} Brown rice syrup \\ 0.289 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Colada morada \\ 0.366 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Brown rice syrup \\ 0.427 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Barley malt syrup \\ 0.240 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Barley malt syrup \\ 0.187 \end{tabular} \\
3&\begin{tabular}[c]{@{}l@{}} Colada morada \\ 0.362 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Pekmez \\ 0.391 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Maple syrup \\ 0.470 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Corn syrup \\ 0.341 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Coconut oil \\ 0.247 \end{tabular} \\
4&\begin{tabular}[c]{@{}l@{}} Corn syrup \\ 0.403 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Tomato juice \\ 0.413 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Pekmez \\ 0.489 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Peanut oil \\ 0.367 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Peanut oil \\ 0.267 \end{tabular} \\
5&\begin{tabular}[c]{@{}l@{}} Pekmez \\ 0.420 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Hot sauce \\ 0.447 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Jallab \\ 0.495 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Colada morada \\ 0.413 \end{tabular}&\begin{tabular}[c]{@{}l@{}} Corn syrup \\ 0.306 \end{tabular} \\
